export const  ExternalUrlMappings = {
    GET_LATEST_DONOR_APPOINTMENT : "donor/get-latest-donor-appointment",
    CREATE_RAW_COLLECTION : "phase/create-raw-collection",
    GET_RAW_COLLECTION : "phase/get-raw-collection",
